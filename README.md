...
Installation:
    ...
    Install the required dependencies using the following commands:
      1. Install ObsPy library for seismic data processing:
          pip install obspy
      2. Install Matplotlib for visualization:
          pip install matplotlib
      3. Install PyGMT library for interactive maps:
          pip install pygmt
      4. Install Pandas library for data manipulation:
          pip install pandas
